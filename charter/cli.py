...
def _add_observe_parser(sub) -> None:
    ...
    act_grp = act.add_mutually_exclusive_group()
    act_grp.add_argument("--runtime-tree", action="store_true", help="Focus on runtime spawn topology.")
    act_grp.add_argument("--declared-relations", action="store_true", help="Focus on declared relationships.")
